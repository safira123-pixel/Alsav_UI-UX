    ...
    return (function () {
        var e = {
                    ...
                    (c || p || f) &&
                        (l = function (e) {
                            var t,
                                ...
                                y = e;
                            return (
                                l && (-1 === (h = h.replace("y", "")).indexOf("g") && (h += "g"), (y = String(e).slice(a.lastIndex)), a.lastIndex > 0 && (!a.multiline || (a.multiline && "\n" !== e[a.lastIndex - 1])) && ((d = "(?: " + d + ")"), (y = " " + y), v++), (n = new RegExp("^(?:" + d + ")", h))),
                ...
                2309: function (e, t, n) {
                    ...
                    })("versions", []).push({ version: "3.9.0", mode: r ? "pure" : "global", copyright: "Â© 2021 Denis Pushkarev (zloirock.ru)" });
                },
                6707: function (e, t, n) {
                    var r = n(9670),
                        i = n(3099),
                                ...
                                { global: !0, enumerable: !0, forced: !0 },
                                {
                                    fetch: function (e) {
                                        var t,
                                            ...
                                            r,
                                            i = [e];
                                        return arguments.length > 1 && (y((t = arguments[1])) && ((n = t.body), d(n) === S && ((r = t.headers ? new k(t.headers) : new k()).has("content-type") || r.set("content-type", "application/x-www-form-urlencoded;charset=UTF-8"), (t = g(t, { body: m(0, String(n)), headers: m(0, r) })))), i.push(t)), E.apply(this, i);
                                    },
                                }
                            ),
            ...
            (function () {
                ...
                var s = {
                    ...
                    params: function (e, t, n) {
                        if (n) return { dzuuid: n.file.upload.uuid, dzchunkindex: n.index, dztotalfilesize: n.file.size, dzchunksize: this.options.chunkSize, dztotalchunkcount: n.file.upload.totalChunkCount, dzchunkbyteoffset: n.index * this.options.chunkSize };
                    },
                    accept: function (e, t) {
                        return t();
                    },
                                ...
                                },
                                {
                                    ...
                                    value: function (e, t, n) {
                                        ...
                                        if (e[0].status !== i.CANCELED && 4 === t.readyState) {
                                            if ("arraybuffer" !== t.responseType && "blob" !== t.responseType && ((r = t.responseText), t.getResponseHeader("content-type") && ~t.getResponseHeader("content-type").indexOf("application/json")))
                                                try {
                                                    r = JSON.parse(r);
                                                } catch (e) {
                                ...
                                },
                                {
                                    ...
                                    value: function (e) {
                                        ...
                                        for (
                                            ...
                                            (t = (this.KEY_STR.indexOf(e.charAt(u++)) << 2) | ((i = this.KEY_STR.indexOf(e.charAt(u++))) >> 4)), (n = ((15 & i) << 4) | ((o = this.KEY_STR.indexOf(e.charAt(u++))) >> 2)), (r = ((3 & o) << 6) | (a = this.KEY_STR.indexOf(e.charAt(u++)))), s.push(t), 64 !== o && s.push(n), 64 !== a && s.push(r), (t = n = r = ""), (i = o = a = ""), u < e.length;
