...
!(function () {
    ...
    $('[data-bs-spy="scroll"]').length &&
        [].slice.call(document.querySelectorAll('[data-bs-spy="scroll"]')).forEach(function (t) {
    ...
    if ($("#perfomanceChart").length) {
        new ApexCharts(document.querySelector("#perfomanceChart"), { series: [100, 78, 89], chart: { height: 320, type: "radialBar" }, colors: ["#28a745", "#ffc107", "#dc3545"], stroke: { lineCap: "round" }, plotOptions: { radialBar: { startAngle: -168, endAngle: -450, hollow: { size: "55%" }, track: { background: "transaprent" }, dataLabels: { show: !1 } } } }).render();
    }
    if ($(".offcanvas").length)
